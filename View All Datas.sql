...
SELECT inv.Invcode, inv.InvDate, CusName as Customer_Name, sta.StaffID, Fullname as Staff_Name, Gen , dob as Date_of_Birth, Position, Salary, pro.ProCode, ProName, invd.Qty, invd.Price, invd.Amount , PayCode, PayDate, pay.Amount as Paid, impd.ImpID, inven as Stock, impd.Price as Cost, impd.amount as Inventory_Cost, sta.FullName As Handle_by, sup.SupID, Supplier, SupAdd  as Address, sup.supcon as Contact
